...
public sealed class AdminDefinitionHandlers
{
    ...
    private SkillDefinitionDto ReadSkillDefinition(IDictionary<string, object> payload)
    {
        ...
        return new SkillDefinitionDto
        {
            ...
            AllowedSubAttributes = GetStringList(map, "allowedSubAttributes"),
            SubAttributeMode = FirstNonEmpty(GetString(map, "subAttributeMode"), "none"),
    ...
    private static Dictionary<string, object> ToPayload(SkillDefinitionDto dto)
    {
        return new Dictionary<string, object>
        {
            ...
            { "defaultSubAttribute", dto.DefaultSubAttribute },
            { "allowedSubAttributes", dto.AllowedSubAttributes.Cast<object>().ToArray() },
            { "subAttributeMode", dto.SubAttributeMode },
            { "rankMin", dto.RankMin },
            { "rankMax", dto.RankMax },
