...
public partial class App : Application
{
    ...
    private static void EnsureThemeFallbackResources()
    {
        ...
        EnsureBrush(resources, "AccentBrush", "#FF2C3A57");
        EnsureBrush(resources, "AccentStrongBrush", "#FF111827");
        ...
        EnsureStyle(resources, "GhostButtonStyle", typeof(Button), _ =>
            new Style(typeof(Button))
            {
                Setters =
                {
                    new Setter(Control.BackgroundProperty, new SolidColorBrush(Color.FromArgb(0x1A, 0xFF, 0xFF, 0xFF))),
                    new Setter(Control.BorderBrushProperty, GetBrush(resources, "BorderBrushTheme")),
                    new Setter(Control.ForegroundProperty, GetBrush(resources, "TextSecondaryBrush")),
    ...
    private static void EnsureBrush(ResourceDictionary resources, string key, string hex)
    {
        ...
        {
            EnsureColor(resources, $"Color{key}", hex);
